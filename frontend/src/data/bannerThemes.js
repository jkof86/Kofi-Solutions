// bannerThemes.js
import googleLogo from "../images/bg/ksLogo4.png"; 
import appleLogo from "../images/bg/ksLogo1.png"; 
import guestLogo from "../images/bg/ksLogo2.png";
...
export const BannerThemes = {
    ...
    guest: {
        gradient: "linear-gradient(to right, #1976d2, #1976d2)",
        background: "#ffffff",
        image: "guestLogo",
        textColor: "#000000"
    },
